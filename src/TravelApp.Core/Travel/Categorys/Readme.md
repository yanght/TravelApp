...
<text name="Category" value=""></text><text name="QueryCategory"  value="查询"></text><text name="CreateCategory"  value="添加"></text><text name="EditCategory"  value="编辑"></text><text name="DeleteCategory"  value="删除"></text><text name="BatchDeleteCategory" value="批量删除"></text><text name="ExportCategory"  value="导出"></text>                             
